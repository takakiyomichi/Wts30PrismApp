...
using Wts30PrismApp.Views;

namespace Wts30PrismApp
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "Wts30PrismApp.ViewModels.{0}ViewModel, Wts30PrismApp", viewType.Name.Substring(0, viewType.Name.Length - 4));
